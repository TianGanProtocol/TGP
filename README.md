...
✅ 开源范围 | What's Open Source：本协议开源的核心是数学模型、群论框架、物理诠释及实现算法，旨在促进科学讨论与跨学科研究。  
...
📄 许可证 | License：本项目采用 CC BY-NC 4.0 许可证。您可以自由分享、演绎本作品，但必须署名（作者：黄裳 / TIANGANPROTOCOL），且不得用于任何商业目的。  
